...
void print_log(struct params_variational_master *pvm);
void print_elapsed_time(struct params_variational_master *pvm);
...
void params_basis_set_init_paths(struct params_basis_set *pbs);
...
void method_rugged(struct params_variational_master *pvm, int select);
